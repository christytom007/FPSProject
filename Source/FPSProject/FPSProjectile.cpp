...
AFPSProjectile::AFPSProjectile()
{
	...
	if(!CollisionComponent)
	{
		...
		CollisionComponent = CreateDefaultSubobject<USphereComponent>(TEXT("SphereCompoent"));
...
void AFPSProjectile::FireInDirection(const FVector& ShootingDirection)
{
	ProjectileMovementComponent->Velocity = ShootingDirection * ProjectileMovementComponent->InitialSpeed;
}
